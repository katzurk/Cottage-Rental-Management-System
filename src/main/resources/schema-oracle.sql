...
CREATE TABLE REQUESTS(
    ...
    COTTAGE_ID NUMBER (4) NOT NULL CONSTRAINT REQUEST_COTTAGE_FK REFERENCES COTTAGES (COTTAGE_ID),
...
CREATE TABLE REQUEST_APPROVALS (
  ...
  REQUEST_ID NUMBER (4) NOT NULL CONSTRAINT REQ_APPROVAL_REQ_FK REFERENCES REQUESTS (REQUEST_ID),
  PRIMARY KEY (REQUEST_APPROVAL_ID)
);

CREATE TABLE REVIEWS(
    REVIEW_ID NUMBER (4) NOT NULL,
    COTTAGE_ID NUMBER (4) NOT NULL CONSTRAINT REVIEW_COTTAGE_FK REFERENCES COTTAGES (COTTAGE_ID),
