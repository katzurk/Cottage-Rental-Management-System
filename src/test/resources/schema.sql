...
CREATE TABLE REQUESTS(
    ...
    COTTAGE_ID BIGINT NOT NULL CONSTRAINT REQUEST_COTTAGE_FK REFERENCES COTTAGES (COTTAGE_ID) ON DELETE CASCADE,
...
CREATE TABLE REQUEST_APPROVALS (
  ...
  REQUEST_ID NUMBER (4) UNIQUE NOT NULL CONSTRAINT REQUEST_APPROVAL_REQUEST_FK REFERENCES REQUESTS (REQUEST_ID) ON DELETE CASCADE,
  PRIMARY KEY (REQUEST_APPROVAL_ID)
);

CREATE TABLE REVIEWS(
    REVIEW_ID BIGINT NOT NULL,
    COTTAGE_ID BIGINT NOT NULL CONSTRAINT REVIEW_COTTAGE_FK REFERENCES COTTAGES (COTTAGE_ID) ON DELETE CASCADE,
